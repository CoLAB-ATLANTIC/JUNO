...
def CCA_frontal_prob_visualization(base_path, df, period_txt, fp_cca, vmax=None):   
...
def main():
    ...
    CCA_frontal_prob_visualization(base_path=base_path, df = df_mur, period_txt=period_txt, fp_cca=fp_cca, vmax=None)
