...
def CCA_front(data_xarray): 
    ...
    The data_xarray parameter is the xarray with the SST data for a certain day
    """
...
##################################################### DOWNLOAD MUR DATA ############################################################################
    ...
    nc_file = os.path.join(nc_file, 'data/MUR_daily_fronts_netcdf/MUR' + day_txt + '.nc')    #Docker
