...
def slice_netcdf(filepath, input_filename, lat_min, lat_max, lon_min, lon_max, output_filename):
...
def eddies_arrays(eddie_cyc_lons, eddie_cyc_lats, centro_cyc_x, centro_cyc_y, eddie_anti_lons, eddie_anti_lats, centro_anti_x, centro_anti_y, input_filename):
...
def main():
    ...
    slice_netcdf(filepath = '/home/luisfigueiredo/JUNO/data/AVISO_data/', input_filename=cyclonic_name[:-3] + '_slice.nc', lat_min=35, lat_max=45, lon_min=330, lon_max=360, output_filename='cyclonic_test.nc')
    slice_netcdf(filepath = '/home/luisfigueiredo/JUNO/data/AVISO_data/', input_filename=anticyclonic_name[:-3] + '_slice.nc', lat_min=35, lat_max=45, lon_min=330, lon_max=360, output_filename='anticyclonic_test.nc')
    ...
    array_cyc_shape, array_cyc_centroids, array_anti_shape, array_anti_centroids = eddies_arrays(eddie_cyc_lons, eddie_cyc_lats, centro_cyc_x, centro_cyc_y, 
                                                                eddie_anti_lons, eddie_anti_lats, centro_anti_x,centro_anti_y, input_filename=cyclonic_name[:-3] + '_slice.nc')
    ...
    nc_file = '/home/luisfigueiredo/JUNO/data/AVISO_netcdf/test.nc'
